...
def generate_xml(img_name,coords,img_size,out_root_path,i):
    '''
    输入：
    ...
    title_text = doc.createTextNode('Manhole_cover')
    ...
    f = open(os.path.join(out_root_path, '{}_{}.xml'.format(img_name[:-4],i)),'w')
